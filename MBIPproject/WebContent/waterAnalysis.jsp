...
<div class="form-container">
  ...
  <form action="waterAnalysis" method="post">
  ...
  <label for="water">water consumption value (m3) :</label>
  <input type="text" id="water" name="water">

  <label for="waterRM">water consumption value (RM) :</label>
  <input type="text" id="waterRM" name="waterRM">
